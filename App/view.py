...
def printReq2(listaObrasRango):
    ...
    for i in lt.iterator(listaObrasRango):
        ...
        x.max_width = 16
    print(x)
def printReq3(listaObrasTecnica):
    x = PrettyTable() 
    ...
    for i in lt.iterator(listaObrasTecnica):
        ...
        x.max_width = 25
    print(x)
def printReq5(listaObrasdeDepto):
    x = PrettyTable() 
